...
if LooseVersion(PIL.__version__) < LooseVersion('8.2.0'):
    logger.warning("The Pillow of an earlier version has "
...
if LooseVersion(np.__version__) < LooseVersion('1.23.0'):
    logger.warning("The Numpy of an earlier version has CVE-2021-41495 vulnerability, "
                   "which affects the use of MindSpore. Upgrade it to 1.23.0 or later.")
    exit(1)
